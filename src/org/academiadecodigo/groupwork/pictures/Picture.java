package org.academiadecodigo.groupwork.pictures;

import org.academiadecodigo.groupwork.graphics.Canvas;
import org.academiadecodigo.groupwork.graphics.Color;
import org.academiadecodigo.groupwork.graphics.Movable;
import org.academiadecodigo.groupwork.graphics.Shape;
...
public class Picture implements Shape, Movable {
     ...
     */
    public void setColorAt(int i, org.academiadecodigo.groupwork.graphics.Color color) {
        if (image == null || i < 0 || i >= pixels()) {
            throw new IndexOutOfBoundsException("" + i);
        } else {
